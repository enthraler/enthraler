		...
		super([
			...
			CreateTable({
				...
				fields: [
					...
					{name:"modified", type:DDateTime, isNullable:false},
					{name:"templateID", type:DInt, isNullable:false},
					{name:"major", type:DTinyInt, isNullable:false},
					{name:"minor", type:DTinyInt, isNullable:false},
					{name:"patch", type:DTinyInt, isNullable:false},
					{name:"basePath", type:DString(255), isNullable:false},
					{name:"mainUrl", type:DString(255), isNullable:false},
					{name:"schemaUrl", type:DString(255), isNullable:false},
					{name:"readme", type:DText, isNullable:true},
				],
				indicies: [
