...
enthraler_Enthraler.loadComponent = function(templateUrl,data,container) {
	if(container == null) {
		container = window.document.createElement("div");
	}
	var dataUrl = typeof(data) == "string" ? data : "local-data";
	...
	var dataPromise = typeof(data) == "string" ? window.fetch(dataUrl).then(function(r) {
		return r.json();
	...
	return Promise.all([componentClassPromise,dataPromise]).then(function(arr) {
		...
		return { container : container, authorData : authorData, enthraler : component};
	});
};
